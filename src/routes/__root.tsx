...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Bangladesh-based travel agency specializing in visa processing, air tickets, hotel bookings, and customized tour packages." },
      { property: "og:image", content: "/og-image.jpg" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Eco Trippers — Travel More. Stress Less." },
      { name: "twitter:description", content: "Bangladesh-based travel agency specializing in visa processing, air tickets, hotel bookings, and customized tour packages." },
